...
PREDICATE_TRACE_TEST(
    test_fn_00, "{\"predicate_counts\":[[[\"icmp\",\"sgt\"],3],[[\"icmp\"," "\"sge\"],1]]}")
PREDICATE_TRACE_TEST( test_bswap_00, "{\"predicate_counts\":[[[\"icmp\",\"sgt\"],1]]}");
PREDICATE_TRACE_TEST(
    test_fabs_00,
    "{\"predicate_counts\":[[[\"icmp\",\"sgt\"],1],[[\"fcmp\",\"oeq\"],2],[[\"icmp\",\"eq\"],1]]}");
